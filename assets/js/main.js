						...
						.on('click', function() {
							...
							// logica da aggiungere per ripulire l'esito della consultazione
							 // alert("ciao");
							  ...
							  document.getElementById("titoloSentenza").innerHTML= "";
							  document.getElementById("titoloImmagine").innerHTML= "";
							  document.getElementById("titoloLineeMobili").innerHTML = "";
							  document.getElementById("titoloSentenzaFinale").innerHTML = "";
                              document.getElementById("titoloImmagineFinale").innerHTML = "";
							  document.getElementById("primaLineaMobile").innerHTML= "";
							  document.getElementById("secondaLineaMobile").innerHTML= "";
							  document.getElementById("terzaLineaMobile").innerHTML= "";
                              ...
                              document.getElementById("immagine_ef").innerHTML = "";

							// e rimettere le indicazioni su come porre la domanda
							document.getElementById("indicazioni").style.display = "block"; 
